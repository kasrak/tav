...
module.exports.attachToElement = function(element) {
    ctx = new svg.Doc(element);
};
...
module.exports.drawTree = function(frozenTree) {
...
module.exports.addLabelToNode = function(text, nodeId) {
    if (!ctx) throw new Error('Attach to element before drawing');
